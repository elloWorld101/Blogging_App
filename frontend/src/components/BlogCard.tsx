        ...
        <div className="flex">
            <div className="flex flex-col items-center border-b ">
                <div className="flex items-center gap-3">
                    ...
                    <h3 className="font-[400] font-roboto text-sm text-gray-600">
                        {authorName}. {published}
                    </h3>
                </div>

                <div className="font-semibold text-xl font-roboto">
                    <h2>{title}</h2>
                </div>

                <div className="font-[500] text-gray-500 font-roboto">
